...
class CondPredictor(nn.Module):
    def __init__(self, N_word, N_h, N_depth, gpu, feats_format=""):
        ...
        self.op_out_dirc_out = nn.Sequential(nn.Tanh(), nn.Linear(50, 12))
    ...
    def forward(self, perm, st, ed, q_emb_var, q_len, col_emb_var, col_len, col_num, col_name_len, gt_cond, q_seq, col_seq, emb_layer, train=True):
        max_q_len = max(q_len)
