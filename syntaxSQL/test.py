...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', type=str, default='',
            help='root path for generated data')
    ...
    model = SuperModel(args.data_root, word_emb, N_word=N_word, gpu=GPU, trainable_emb = args.train_emb, table_type=args.table_type, use_hs=use_hs, feats_format=args.feats_format)
    ...
    model.andor.load_state_dict(torch.load("{}/andor_models.dump".format(args.models)))

    test_acc(model, BATCH_SIZE, data, args.output_path, args.table_path)
    #test_exec_acc()
