...
if __name__ == '__main__':
    ...
    if args.train_component == "multi_sql":
        ...
        model = OpPredictor(N_word=N_word,N_h=N_h,N_depth=N_depth,gpu=GPU, use_hs=use_hs, feats_format=args.feats_format)
        ...
        model = DesAscLimitPredictor(N_word=N_word,N_h=N_h,N_depth=N_depth,gpu=GPU, use_hs=use_hs, feats_format=args.feats_format)
    ...
    print_flag = False
    embed_layer = WordEmbedding(args.data_root, word_emb, N_word, gpu=GPU,
                                SQL_TOK=SQL_TOK, trainable=args.train_emb, feats_format=args.feats_format)
